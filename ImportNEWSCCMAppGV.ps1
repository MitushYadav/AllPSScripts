...
$Global:SCCMSiteServer01 = 'EWP001704'
...
#SOFTWARE GENERAL
$Global:PackageSourcesShare = "\\$DomainFQDN\adm\WSAAS\Software Deployment\Packages\"
#SOFTWARE PER TECHNOLOGY
<#$Global:AppVPackagesShare = "\\$DomainFQDN\ADM\PackageSources\AppV\X64\" Not Global Anymore
$Global:ApplicationsShare = "\\$DomainFQDN\ADM\PackageSources\SCCM\W7\x64\"
$Global:PackagesShare = "\\$DomainFQDN\ADM\PackageSources\SCCM\W7\x64\" Not using packages anymore
#>
...
#$Global:AppVSharePublisherAppNameAppVersionPackageVersion01 = @(7,8,9,10) # This is same line again
...
$Global:CMNewApplicationCollectionFolderPath  = "$SCCMSiteCode01\Software\W7-Applications\NEW" # to be finalized
$Global:CMNewApplicationFolderPath = "$SCCMSiteCode01\NEW" # to be finalized
...
<#$Global:CMLimitingCollectionW10 = 'PRD - DCO - W10 - All'   # to be finalized
$Global:CMOUPathAppV = 'OU=App-V,OU=Software W10,OU=IT,DC=prod,DC=telenet,DC=be'
